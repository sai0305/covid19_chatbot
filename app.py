...
def processRequest(req):
    ...
    if intent == 'covid_searchcountry':
        ...
        webhookresponse = "World wide Cases \n\n" + " Confirmed cases :" + str(
        ...
        return {
            ...
            "fulfillmentMessages": [
                ...
                },
                {
                    "text": {
                        "text": [
                            "Type main menu / exit"#Do you want me to send the detailed report to your e-mail address? Type.. \n 1. Sure \n 2. Not now "
                            # "We have sent the detailed report of {} Covid-19 to your given mail address.Do you have any other Query?".format(cust_country)
                        ]
...
def configureDataBase():
    client = MongoClient("mongodb+srv://covid:xyz@cluster0-bh0k2.mongodb.net/test?retryWrites=true&w=majority")
